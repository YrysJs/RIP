...
function getAppeals(params) {
    ...
    return $axios({
        method: 'GET',
        url: 'https://194.32.140.103:8081/rip-government/v1/appeal',
        params,
    })
}
...
function createRequest(data) {
    ...
    return $axios({
        method: 'PUT',
        url: 'https://194.32.140.103:8081/rip-government/v1/request',
        data,
    })
}
...
function processCardPayment(data) {
    ...
    return $axios({
        method: 'POST',
        url: 'https://194.32.140.103:8091/card',
        data
    })
}
...
function getProducts(params) {
    ...
    return $axios({
        method: 'GET',
        url: 'https://194.32.140.103:8090/api/v1/products',
        params,
    })
}
...
function getProductById(id) {
    ...
    return $axios({
        method: 'GET',
        url: `https://194.32.140.103:8090/api/v1/products/${id}`,
    })
}
...
function getProductReviews(productId, params) {
    ...
    return $axios({
        method: 'GET',
        url: `https://194.32.140.103:8090/api/v1/reviews/products/${productId}`,
        params,
    })
}
...
function getProviderReviews(providerId, params) {
    ...
    return $axios({
        method: 'GET',
        url: `https://194.32.140.103:8090/api/v1/reviews/providers/${providerId}`,
        params,
    })
}
...
function getGraves(params) {
    ...
    return $axios({
        method: 'GET',
        url: 'https://194.32.140.103:8092/api/v1/graves',
        params,
    })
}
...
function getGraveById(id) {
    ...
    return $axios({
        method: 'GET',
        url: `https://194.32.140.103:8092/api/v1/graves/${id}`,
    })
}
...
function getGraveImages(id) {
    ...
    return $axios({
        method: 'GET',
        url: `https://194.32.140.103:8092/api/v1/graves/${id}/photos`,
    })
}
...
function createDeceased(data) {
    ...
    return $axios({
        method: 'POST',
        url: 'https://194.32.140.103:8095/api/v1/deceased',
        data,
    })
}
...
function getDeceasedById(id) {
    ...
    return $axios({
        method: 'GET',
        url: `https://194.32.140.103:8095/api/v1/deceased/${id}`,
    })
}
...
function getCart() {
    ...
    return $axios({
        method: 'GET',
        url: 'https://194.32.140.103:8090/api/v1/cart',
    })
}
...
function removeFromCart(productId) {
    ...
    return $axios({
        method: 'DELETE',
        url: `https://194.32.140.103:8090/api/v1/cart/${productId}`,
    })
}
...
function getOrders(params) {
    ...
    return $axios({
        method: 'GET',
        url: 'https://194.32.140.103:8090/api/v1/orders',
        params,
    })
}
...
function updateBurialRequestStatus(requestId, data) {
    ...
    return $axios({
        method: 'PATCH',
        url: `https://194.32.140.103:8094/api/v1/burial-requests/${requestId}/status`,
        data,
    })
}
...
function updateBurialRequestData(requestId, data) {
    ...
    return $axios({
        method: 'PUT',
        url: `https://194.32.140.103:8094/api/v1/burial-requests/${requestId}`,
        data,
    })
}
...
function uploadBurialRequestDocument(requestId, document) {
    ...
    return $axios({
        method: 'POST',
        url: `https://194.32.140.103:8094/api/v1/burial-requests/${requestId}/document`,
        data: formData,
    })
}
...
function uploadDeceasedDeathCertificate(deceasedId, certificate) {
    ...
    return $axios({
        method: 'POST',
        url: `https://194.32.140.103:8095/api/v1/deceased/${deceasedId}/death-certificate`,
        data: formData,
    })
}
...
function postReview(data) {
    ...
    return $axios({
        method: 'POST',
        url: 'https://194.32.140.103:8090/api/v1/reviews',
        data: formData,
    })
}
...
function createProductReview(data) {
    ...
    return $axios({
        method: 'POST',
        url: 'https://194.32.140.103:8090/api/v1/reviews/products',
        data: formData,
    })
}
...
function getMemorials(params) {
    ...
    return $axios({
        method: 'GET',
        url: 'https://194.32.140.103:8090/api/v1/memorials',
        params,
    })
}
...
function searchDeceased(data) {
    ...
    return $axios({
        method: 'POST',
        url: 'https://194.32.140.103:8095/api/v1/search-requests',
        data,
    })
}
...
function getMemorialById(id) {
    ...
    return $axios({
        method: 'GET',
        url: `https://194.32.140.103:8090/api/v1/memorials/${id}`,
    })
}
