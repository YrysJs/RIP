<template>
  <div class="w-full bg-white rounded-[16px] py-[20px] px-[12px]">
    ...
    <div class="flex justify-between items-center border-b-2 border-[#EEEEEE] pb-[16px] mt-[16px]">
      <h3 class="text-lg font-medium">{{ $t('ennoblement.requestNumber') }} {{ request.id }}</h3>
      <p class="text-sm">{{ $t('ennoblement.requestDateTime') }} {{ request.createdAt }}</p>
    </div>
    ...
    <div class="flex justify-between items-start mt-[16px] border-b-2 border-[#EEEEEE] pb-[16px]">
      <div class="min-w-[580px] font-medium flex flex-col gap-[10px]">
        <div class="flex text-base"><p class="min-w-[150px]">{{ $t('ennoblement.cemetery') }}</p><p class="font-bold">{{ request.cemetery }}</p></div>
        <div class="flex text-base"><p class="min-w-[150px]">{{ $t('ennoblement.sector') }}</p><p class="font-bold">{{ request.sector }}</p></div>
        <div class="flex text-base"><p class="min-w-[150px]">{{ $t('ennoblement.place') }}</p><p class="font-bold">{{ request.place }}</p></div>
        <div class="flex text-base"><p class="min-w-[150px]">{{ $t('ennoblement.deceasedFullName') }}</p><p class="font-bold">{{ request.deceased }}</p></div>
      </div>
      <button class="rounded-md w-[140px] h-[30px] text-sm text-[#224C4F] font-semibold bg-[#EEEEEE]">{{ $t('ennoblement.plotData') }}</button>
    </div>

    <div class="flex justify-between items-start mt-[16px] border-b-2 border-[#EEEEEE] pb-[16px]">
      <div class="min-w-[580px] font-medium flex flex-col gap-[10px]">
        <div class="flex text-base"><p class="min-w-[150px]">{{ $t('ennoblement.customer') }}</p><p class="font-bold">{{ request.client }}</p></div>
        <div class="flex text-base"><p class="min-w-[150px]">{{ $t('ennoblement.contacts') }}</p><p class="font-bold">{{ request.phone }}</p></div>
      </div>
    </div>

    <div class="mt-[16px] border-b-2 border-[#EEEEEE] pb-[16px]">
      <p class="font-medium text-base mb-[10px]">{{ $t('ennoblement.services') }}</p>
    ...
    <div class="mt-[16px] border-b-2 border-[#EEEEEE] pb-[16px]">
      <p class="font-medium text-base mb-[4px]">{{ $t('ennoblement.comment') }}</p>
    ...
    <div class="flex justify-between items-start mt-[16px]">
      <div class="flex flex-col gap-[8px]">
        <div class="flex text-base">
          <p class="min-w-[150px] font-medium">{{ $t('ennoblement.status') }}</p>
