          ...
          <ul class="menu-list">
            <li>
              <NuxtLink 
                to="/manager/burial" 
                class="menu-item"
                :class="{ active: $route.path === '/manager/burial' }"
                @click="closeMenu"
              >
                {{ $t('manager.sidebar.burialRequests') }}
              </NuxtLink>
            </li>
            <li>
              <NuxtLink 
                to="/manager/cemetery" 
                class="menu-item"
                :class="{ active: $route.path === '/manager/cemetery' }"
                @click="closeMenu"
              >
                {{ $t('manager.sidebar.cemeteriesManagement') }}
              </NuxtLink>
            </li>
            <li>
              <NuxtLink 
                ...
                class="menu-item"
                :class="{ active: $route.path === '/manager/notifications' }"
                @click="closeMenu"
              >
                {{ $t('manager.sidebar.notifications') }}
              </NuxtLink>
            </li>
          </ul>
        </div>
