...
import { updateBurialRequestStatus, uploadDeceasedDeathCertificate } from '~/services/client'
  ...
  methods: {
    ...
    async processPayment() {
      ...
      try {
        ...
        // 2. Обновляем статус заявки на захоронение
        ...
        // 3. Загружаем сертификат о смерти, если он есть
        ...
        // 4. Закрываем модалку и сообщаем о успешной оплате
        this.$emit('close')
        this.$emit('success')
