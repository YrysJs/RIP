...
const link = computed(() =>
  `https://2gis.kz/almaty/search/${props.lat},${props.lng}/geo/${props.lng},${props.lat}?m=${props.lng},${props.lat}/17`
)
        ...
        <div class="flex flex-col gap-[12px]">
            <div class="mb-6 w-full flex justify-between items-center gap-[10px]">
                <div class="flex flex-col gap-[10px]">
                    ...
                    <p class="font-bold truncate-middle">{{ `https://2gis.kz/map?lat=${props.lat}&lng=${props.lng}&z=17` }}</p>
                </div>
