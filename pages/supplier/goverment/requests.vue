...
<template>
     <NuxtLayout name="supplier">
        <div class="w-full py-4 pl-[20px] flex items-center bg-white rounded-[16px] text-lg font-semibold flex justify-between items-center">
            <h1>Обращения в Акимат</h1> <button @click="router.push('/supplier/goverment/create')" class="bg-[#38949B] text-white px-[16px] py-[8px] rounded-[8px]">Создать обращение</button>
        </div>
