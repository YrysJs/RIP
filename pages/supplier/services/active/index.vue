        ...
        <div class="w-full bg-white rounded-[16px] mt-[20px] py-[20px] px-[12px]">
            <div class="w-full flex gap-[20px]">
                <div class="min-w-[320px] w-[320px] rounded-lg overflow-hidden">
                    <img class="w-full h-full object-cover" src="/images/test-card-car.jpg" alt="">
                </div>
                <div class="w-full">
                    <div class="flex justify-between items-start mb-[3px]">
                        <div>
                            <h3 class="font-medium text-lg">Доставка покойного</h3>
                            <p class="text-sm text-[#939393]">Ритуальный транспорт</p>
                        </div>
                    ...
                    <div class="flex justify-end gap-[10px] items-center mt-[40px]">
                        <nuxt-link to="/supplier/services/consideration" class="py-[8px] px-[16px] rounded-md bg-[#D63C3C26] text-[#D63C3C] font-semibold">Деактивировать</nuxt-link>
