        ...
        <div class="flex flex-wrap items-center gap-4">
          ...
          >
            <div
              ...
              class="animate-spin rounded-full border-b-2 border-white text-xs"
            />
            {{
              markingAllAsRead
                ? "Обновление..."
        ...
        >
          ...
          >
            <div class="flex flex-col flex-1">
              ...
              <p v-if="notification.content" class="text-xs text-gray-600 mt-1">
                {{ notification.content }}
              </p>
              <p class="text-xs text-[#224C4F] mt-1">
