...
<template>
     <NuxtLayout name="client">
        <div class="w-full py-4 pl-[20px] flex items-center bg-white rounded-[16px] text-lg font-semibold flex justify-between items-center">
            <h1>Заявки на перезахоронение</h1> <button @click="router.push('/client/goverment/create')" class="bg-[#38949B] text-white px-[16px] py-[8px] rounded-[8px]">Создать заявку</button>
        </div>
